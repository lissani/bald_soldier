# 대머리 용사의 모자 구하기 대작전 🎩⚔️

본 프로젝트는 서강대학교 [CSE4170/AIE4012] 기초 컴퓨터 그래픽스 과목의 2차 과제로,  
OpenGL Core Profile 기반의 2D 객체들을 아핀 변환을 통해 정적·동적 효과로 표현하는 실습입니다.

## ✨ 주요 내용

- 2D 객체에 대해 `glm::translate`, `glm::scale`, `glm::rotate` 등의 변환 함수를 활용한 아핀 변환 구현
- 삼각 함수 기반 궤도 회전, 크기 변형, 배경 색상 변화 등 다양한 애니메이션 효과 적용
- 계층적 모델링(Hierarchical Modeling)을 통해 검과 강아지를 용사와 함께 움직이도록 구성
- 마우스 이벤트 입력을 활용한 인터랙션 (용사 이동)
- 직접 모델링한 캐릭터(용사, 강아지)를 포함한 2D 그래픽 구성
...
- 과목: CSE4170 / AIE4012 기초 컴퓨터 그래픽스
- 과제명: HW2 – OpenGL API 함수를 사용한 2차원 모델링 변환 연습
- 담당교수: 임인성 교수님
- 제출일: 2025.05.04
---
